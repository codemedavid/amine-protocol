...
export default function HeroSection({ onShopAll }: HeroSectionProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div ref={badgeRef} className="inline-flex items-center gap-2 bg-accent-light border border-accent rounded-full px-4 py-2 w-fit">
              ...
              <span className="text-sm font-medium text-primary">Third-party tested for every batch</span>
            </div>
            ...
            <div ref={socialRef} className="flex items-center gap-4 pt-2">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span className="font-medium text-primary">Trusted by Researchers</span>
              </div>
            </div>
          </div>
          ...
          <div ref={imageRef} className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg">
              {/* Hero visual */}
              <div className="relative bg-gradient-to-br from-accent-light to-accent rounded-3xl p-10 flex items-center justify-center min-h-[380px]">
                ...
                <div className="relative z-10 text-center">
                  <div className="w-28 h-28 mx-auto bg-white/80 backdrop-blur rounded-3xl shadow-card flex items-center justify-center mb-4">
                    <svg viewBox="0 0 64 64" className="w-16 h-16 text-secondary" fill="none" stroke="currentColor" strokeWidth="1.5">
                      ...
                      <circle cx="28" cy="50" r="2.5" fill="currentColor" opacity="0.3" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-bold text-primary mb-1">The Amine Protocol</h3>
                  <p className="text-sm text-muted-foreground">Premium Peptide Science</p>
                </div>
              </div>
