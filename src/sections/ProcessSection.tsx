...
const steps = [
  {
    ...
    description: 'Explore the compound library and review detailed specifications, research information, and batch availability.',
  },
  {
    number: '02',
  ...
  },
  {
    ...
    description: 'Complete your order through encrypted checkout systems with structured processing protocols.',
  },
  {
    number: '04',
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-white/10">
            <div className="flex items-center gap-4">
              ...
              <p className="text-white/80 text-sm">
                Join the likes of <span className="text-white font-semibold">20,000+</span> satisfied customers
              </p>
            </div>
            <a
              href="#shop"
